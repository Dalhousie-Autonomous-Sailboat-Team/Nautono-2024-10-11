...
\DoxyCodeLine{9 \textcolor{preprocessor}{\#define beacon}}
\DoxyCodeLine{10 }
...
\DoxyCodeLine{14 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{sail__nmea_8h}{sail\_nmea.h}}"{}}}
...
\DoxyCodeLine{37 }
\DoxyCodeLine{38 \textcolor{preprocessor}{\#define WEATHER\_SENSOR\_PRIORITY           tskIDLE\_PRIORITY + 4}}
\DoxyCodeLine{39 \textcolor{preprocessor}{\#define UPDATE\_COURSE\_PRIORITY            tskIDLE\_PRIORITY + 3}}
\DoxyCodeLine{40 \textcolor{preprocessor}{\#define CONTROL\_RUDDER\_PRIORITY           tskIDLE\_PRIORITY + 3}}
\DoxyCodeLine{41 \textcolor{preprocessor}{\#define RADIO\_HANDLER\_PRIORITY            tskIDLE\_PRIORITY + 1}}
\DoxyCodeLine{42 \textcolor{preprocessor}{\#define LOG\_DATA\_PRIORITY                 tskIDLE\_PRIORITY + 2}}
\DoxyCodeLine{43 \textcolor{preprocessor}{\#define READ\_COMPASS\_PRIORITY             tskIDLE\_PRIORITY + 3}}
\DoxyCodeLine{44 \textcolor{preprocessor}{\#define READ\_WIND\_VANE\_PRIORITY           tskIDLE\_PRIORITY + 1}}
\DoxyCodeLine{45 \textcolor{preprocessor}{\#define WATCHDOG\_PRIORITY                 tskIDLE\_PRIORITY}}
\DoxyCodeLine{46 }
\DoxyCodeLine{47 \textcolor{preprocessor}{\#define WEATHER\_SENSOR\_STACK\_SIZE         configMINIMAL\_STACK\_SIZE}}
\DoxyCodeLine{48 \textcolor{preprocessor}{\#define UPDATE\_COURSE\_STACK\_SIZE          configMINIMAL\_STACK\_SIZE}}
\DoxyCodeLine{49 \textcolor{preprocessor}{\#define CONTROL\_RUDDER\_STACK\_SIZE         configMINIMAL\_STACK\_SIZE}}
\DoxyCodeLine{50 \textcolor{comment}{// The radio stack size was increased because the small stack size caused the radio task stack to overflow}}
\DoxyCodeLine{51 \textcolor{preprocessor}{\#define RADIO\_HANDLER\_STACK\_SIZE          configMINIMAL\_STACK\_SIZE + 100}}
\DoxyCodeLine{52 \textcolor{preprocessor}{\#define LOG\_DATA\_STACK\_SIZE               configMINIMAL\_STACK\_SIZE }}
\DoxyCodeLine{53 \textcolor{preprocessor}{\#define READ\_COMPASS\_STACK\_SIZE           configMINIMAL\_STACK\_SIZE }}
\DoxyCodeLine{54 \textcolor{preprocessor}{\#define WATCHDOG\_STACK\_SIZE               configMINIMAL\_STACK\_SIZE}}
\DoxyCodeLine{55 \textcolor{preprocessor}{\#define READ\_WIND\_VANE\_STACK\_SIZE         configMINIMAL\_STACK\_SIZE}}
\DoxyCodeLine{56 }
...
\DoxyCodeLine{59 \textcolor{keyword}{extern} \textcolor{keyword}{volatile} \mbox{\hyperlink{struct_w_e_a_t_h_e_r_s_e_n_s_o_r___all_msgs}{WEATHERSENSOR\_AllMsgs}} weathersensor\_data;}
\DoxyCodeLine{60 }
\DoxyCodeLine{61 \textcolor{keyword}{extern} \textcolor{keyword}{enum} all\_tasks running\_task;}
\DoxyCodeLine{62 }
\DoxyCodeLine{63 }
