...
#define GPS_LOOP_LIM 5000 //max number of loops allowed before gps task is put to sleep
#define GPS_SLEEP_PERIOD_MS 1000	 //length of time in sec that puts gps to sleep
