...
#define WIND_SLEEP_PERIOD_MS 1000 // Length of time in msec that puts gps to sleep 
...
// void write_to_wind(const char* format, ...);

void ReadWIND(void);
void WIND_On(void);
// void WIND_Sleep_Sec(unsigned time_sec);
